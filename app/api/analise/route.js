...
export async function POST(req) {
  try {
    ...
    if (isJson) {
      // PROMPT DA AUDITORIA INICIAL (Economizando tokens com dados pré-extraídos)
...

{
  ...
  "score": 75, 
  "resumoExecutivo": "Diagnóstico tático focando no nível de exigência.",
  ...
  "minutaImpugnacao": "Esqueleto formal de impugnação",
  "proximosPassos": ["..."]
}
...
${textoComprimido.slice(0, 25000)}`;
      ...
      // PROMPT DO CHAT (Garantindo ausência de alucinações nas respostas interativas)
